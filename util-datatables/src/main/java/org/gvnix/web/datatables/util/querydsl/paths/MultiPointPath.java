...
import org.gvnix.web.datatables.util.querydsl.MultiPointExpression;
 ...
 * @param <T>
 */
public class MultiPointPath<T extends MultiPoint> extends
        MultiPointExpression<T> implements Path<T> {
    ...
    public MultiPointPath(Class<? extends T> type, Path<?> parent,
            String property) {
    ...
    public MultiPointPath(String var) {
        this((Class<? extends T>) MultiPoint.class, PathMetadataFactory
                .forVariable(var));
    }
