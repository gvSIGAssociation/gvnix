...
public final class GeometryExpressions {
    ...
    public static GeometryExpression<?> fromText(String text) {
        return GeometryOperation.create(Geometry.class,
                SpatialOps.GEOM_FROM_TEXT, ConstantImpl.create(text));
    }
    ...
    public static GeometryExpression<?> fromText(Expression<String> text) {
        return GeometryOperation.create(Geometry.class,
                SpatialOps.GEOM_FROM_TEXT, text);
    }
     ...
     * @return
     */
    public static <T extends Geometry> GeometryExpression<T> setSRID(
            Expression<T> expr, int srid) {
        return (GeometryExpression) GeometryOperation.create(expr.getType(),
                SpatialOps.SET_SRID, expr, ConstantImpl.create(srid));
    }
    ...
    public static BooleanExpression dwithin(
        ...
        return BooleanOperation.create(SpatialOps.DWITHIN, expr1, expr2,
                distance);
    }
     ...
     * @return
     */
    public static GeometryExpression<?> extent(
            Expression<? extends GeometryCollection> collection) {
        return GeometryOperation.create(Geometry.class, SpatialOps.EXTENT,
                collection);
    }
    ...
    public static GeometryExpression<?> collect(
            Expression<? extends GeometryCollection> collection) {
        return GeometryOperation.create(Geometry.class, SpatialOps.COLLECT,
                collection);
    }
    ...
    public static GeometryExpression<?> collect(
        ...
        return GeometryOperation.create(Geometry.class, SpatialOps.COLLECT2,
                expr1, expr2);
    }
    ...
    public static <T extends Geometry> GeometryExpression<T> translate(
        ...
        return (GeometryExpression) GeometryOperation.create(expr.getType(),
                SpatialOps.TRANSLATE, expr, ConstantImpl.create(deltax),
    ...
    public static <T extends Geometry> GeometryExpression<T> translate(
        ...
        return (GeometryExpression) GeometryOperation.create(expr.getType(),
                SpatialOps.TRANSLATE2, expr, ConstantImpl.create(deltax),
                ConstantImpl.create(deltay), ConstantImpl.create(deltaz));
    }
