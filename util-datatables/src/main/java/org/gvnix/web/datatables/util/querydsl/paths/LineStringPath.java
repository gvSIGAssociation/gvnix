...
import org.gvnix.web.datatables.util.querydsl.LineStringExpression;
 ...
 * @param <T>
 */
public class LineStringPath<T extends LineString> extends
        LineStringExpression<T> implements Path<T> {
    ...
    public LineStringPath(Class<? extends T> type, Path<?> parent,
            String property) {
    ...
    public LineStringPath(String var) {
        this((Class<? extends T>) LineString.class, PathMetadataFactory
                .forVariable(var));
    }
