 ...
 * Copyright (C) 2010, 2011, 2012, 2013 CIT - Generalitat Valenciana
 *
...
/**
 * This class is a proxy service for {@link MenuOperations}.
 * <br>
 * This instance delegates on {@link MenuOperationsImpl} or in
 * original Roo's {@link MenuOperations} service depending on
 * runtime parameters.
 * <br><br>
 * <b>Very Important</b> This service <b>MUST HAS NONE</b> {@link Reference}
 * property to assure this component is really loaded immediately.
 * <br><br>
...
public class MenuOperationsProxy implements MenuOperations {
	...
	/* (non-Javadoc)
	 * @see org.springframework.roo.addon.web.mvc.jsp.menu.MenuOperations#addMenuItem(org.springframework.roo.model.JavaSymbolName, org.springframework.roo.model.JavaSymbolName, java.lang.String, java.lang.String, java.lang.String, org.springframework.roo.project.LogicalPath)
	 */
	public void addMenuItem(JavaSymbolName menuCategoryName,
		...
		getOperations().addMenuItem(menuCategoryName, menuItemId, globalMessageCode, link, idPrefix, logicalPath);
	}

	/* (non-Javadoc)
	 * @see org.springframework.roo.addon.web.mvc.jsp.menu.MenuOperations#addMenuItem(org.springframework.roo.model.JavaSymbolName, org.springframework.roo.model.JavaSymbolName, java.lang.String, java.lang.String, java.lang.String, java.lang.String, org.springframework.roo.project.LogicalPath)
	 */
	public void addMenuItem(JavaSymbolName menuCategoryName,
			JavaSymbolName menuItemId, String menuItemLabel,
			String globalMessageCode, String link, String idPrefix,
			LogicalPath logicalPath) {
		getOperations().addMenuItem(menuCategoryName, menuItemId, menuItemLabel, globalMessageCode, link, idPrefix, logicalPath);
	}

	/* (non-Javadoc)
	 * @see org.springframework.roo.addon.web.mvc.jsp.menu.MenuOperations#cleanUpFinderMenuItems(org.springframework.roo.model.JavaSymbolName, java.util.List, org.springframework.roo.project.LogicalPath)
	 */
	public void cleanUpFinderMenuItems(JavaSymbolName menuCategoryName,
		...
		getOperations().cleanUpFinderMenuItems(menuCategoryName, allowedFinderMenuIds, logicalPath);
	}

	/* (non-Javadoc)
	 * @see org.springframework.roo.addon.web.mvc.jsp.menu.MenuOperations#cleanUpMenuItem(org.springframework.roo.model.JavaSymbolName, org.springframework.roo.model.JavaSymbolName, java.lang.String, org.springframework.roo.project.LogicalPath)
	 */
	public void cleanUpMenuItem(JavaSymbolName menuCategoryName,
			JavaSymbolName menuItemName, String idPrefix,
			LogicalPath logicalPath) {
		getOperations().cleanUpMenuItem(menuCategoryName, menuItemName, idPrefix, logicalPath);
	}
}
