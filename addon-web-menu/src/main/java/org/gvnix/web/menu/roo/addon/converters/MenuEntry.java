 ...
 */
package org.gvnix.web.menu.roo.addon.converters;
 ...
 * <p>
 * Provides conversion from page ID to XML Element used for shell 
 * autocompletion purpouses.
 *
...
public class MenuEntry {
  ...
  public MenuEntry(Element pageItem) {
    ...
    this.hidden = parseBoolean(pageItem.getAttribute(XML_ATTR_HIDDEN), false);
  }

  /**
   * Utility method to convert this.id to JavaSymbolName. It is useful to
   * maintain Roo representation, Roo uses JavaSymbolName to identify a 
   * page menu entry.
   *  
   * @return
   */
