...
/**
 * Abtract class for gvNIX menu metadata
 *
 ...
 */
public abstract class AbstractMenuMetadata extends AbstractMetadataItem {

    protected PhysicalTypeMetadata physicalTypeMetadatal;

    public AbstractMenuMetadata(String id,
	    PhysicalTypeMetadata physicalTypeMetadata) {
	super(id);
	this.physicalTypeMetadatal = physicalTypeMetadata;
    }

    public PhysicalTypeMetadata getPhysicalTypeMetadata() {
	return this.physicalTypeMetadatal;
    }
