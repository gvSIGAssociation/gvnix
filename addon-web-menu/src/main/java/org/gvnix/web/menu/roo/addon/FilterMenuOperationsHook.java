 ...
 * <ul>
 * <li><i>For request from other bundles</i> Return just one result: {@link MenuOperationsProxy}</li>  
 * <li><i>For request from this bundles</i> Return all services</li>
 * </ul>
 * <br>
 * To identify the kind of service without accessing to its class instance, it uses service properties
 * declared on {@link MenuOperationsImpl} and {@link MenuOperationsProxy}. The service reference which has
 * no properties is the original service.
 * <br><br>
