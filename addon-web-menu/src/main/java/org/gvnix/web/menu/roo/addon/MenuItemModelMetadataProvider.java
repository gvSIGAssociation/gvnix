...
/**
 * Metada provider for gvNIX menu item model
 *
...
@Service
public class MenuItemModelMetadataProvider extends AbstractMenuMetadataProvider {
	...
	return MenuItemModelMetadata.getMetadataIdentiferType();
    }

    @Override
    protected String getMetadataIdentiferFinal() {
	return MenuItemModelMetadata.getMetadataIdentiferFinal();
    }
	...
	return new MenuItemModelMetadata(physicalTypeMetadata);
    }

    @Override
    protected Class getAnnotationClass() {
	return GvNIXMenuItemModel.class;
    }
