 ...
 */
public class MenuModelMetadata extends AbstractMenuMetadata {

    private static final String PROVIDES_TYPE_STRING = MenuModelMetadata.class
	    .getName();
    private static final String PROVIDES_TYPE = MetadataIdentificationUtils
	    .create(PROVIDES_TYPE_STRING);

    public MenuModelMetadata(PhysicalTypeMetadata physicalTypeMetadata) {
