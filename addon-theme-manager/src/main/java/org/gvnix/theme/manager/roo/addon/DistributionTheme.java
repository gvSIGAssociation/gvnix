...
/**
 * Representation of gvNIX distribution theme values.
 * 
 ...
 * 
 */
public class DistributionTheme extends Theme {

    public DistributionTheme() {
	super();
    }

    public DistributionTheme(Element themeElement) {
	super(themeElement);
    }
}
