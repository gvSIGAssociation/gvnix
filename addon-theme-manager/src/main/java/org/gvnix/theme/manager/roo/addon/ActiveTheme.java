...
/**
 * Representation of application activated theme values.
 * 
...
public class ActiveTheme extends Theme {
    ...
    public ActiveTheme(Element themeElement) {
	...
	this.id = themeId.getTextContent();

	this.name = themeId.getTextContent();
    }
