 ...
 */
public class OCCChecksumMetadata extends AbstractMetadataItem {
    ...
    private static final String TO_STRING_CODE_LINE_FORMAT = "\tsb.append((${property} == null ? nullstr : ${property}.toString()) + separator);\n";
    ...
    public OCCChecksumMetadata(String identifier, JavaType aspectName,
	    ...
	    EntityMetadata entityMetadata, EntityMetadata parent,
