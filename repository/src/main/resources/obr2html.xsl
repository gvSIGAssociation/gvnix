...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="header">
	  	<header id="masthead" class="blog-background overlay align-center align-bottom animated from-bottom animation-on" style="background-image: url(http://www.gvnix.org/assets/themes/gvnix-omega-multilanguage/images/default_bg_header.png)">
	...
	<xsl:template name="footer">
		...
		<footer id="footer" class="blog-background overlay text-center align-middle animated from-top" style="background-image: url(http://www.gvnix.org/assets/themes/gvnix-omega-multilanguage/images/default_bg_header.png)">
