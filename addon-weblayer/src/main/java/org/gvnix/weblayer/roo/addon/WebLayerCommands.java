...
/**
 * Web Layer add-on command class The command class is registered by the Roo
...
public class WebLayerCommands implements CommandMarker {
   ...
   * not be visible. For example the 'entity' command will not be made available
   * before the user has defined his persistence settings in the Roo shell or
   * directly in the project. You can define multiple methods annotated with
   * {@link CliAvailabilityIndicator} if your commands have differing visibility
   * requirements.
   * 
   * @return true (default) if the command should be visible at this stage,
   *         false otherwise
   */
  @CliAvailabilityIndicator({ "web layer setup", "web layer show" })
  ...
  public void scaffoldshow(@CliOption(key = "class", mandatory = true, help = "The entity to define the web layer view show") JavaType entity,
