...
import com.github.dandelion.datatables.jsp.tag.ExtraFileTag;

/**
 * Extends {@link ExtraFileTag} to avoid locate table tag container problems
 * 
 * @author gvNIX Team
 */
public class RooExtraFileTag extends ExtraFileTag {

    /**
	 * 
	 */
    private static final long serialVersionUID = 6803811333188319793L;
