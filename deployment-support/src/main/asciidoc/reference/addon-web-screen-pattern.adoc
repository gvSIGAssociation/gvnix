...
image::tabular.png[Patrón maestro,align=center]
...
ifdef::backend-html5[]
image::master-detail.png[Patrón maestro con un detalle,align=center]
endif::backend-html5[]

ifdef::backend-pdf[]
image::master-detail.png[Patrón maestro con un detalle,align=center, width=300]
endif::backend-pdf[]
...
image::tabular.png[Tabular,align=center]
...
ifdef::backend-html5[]
image::edit.png[Edición,align=center]
endif::backend-html5[]

ifdef::backend-pdf[]
image::edit.png[Edición,align=center,width=400]
endif::backend-pdf[]
...
image::register.png[Registro,align=center]
