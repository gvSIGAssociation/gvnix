...
http://docs.spring.io/spring-roo/docs/2.0.0.BUILD-SNAPSHOT/reference/html/[documentación de referencia].
...
=== 4. Novedades de la versión 2.0.0.M1

==== Roo Add-On Suite

gvNIX deja de ser una distribución personalizada de Spring Roo y se convierte en un "Roo Add-On Suite". 
Además, se incluye gvNIX en el http://projects.spring.io/spring-roo/marketplace/[Spring Roo MarketPlace], 
estando disponible para toda la comunidad.

==== Reestructuración de paquetes

Para facilitar el desarrollo de nuevos componentes en la versión 2.0.0.M1 de gvNIX, se han reorganizado los 
paquetes internos de cada uno de los add-ons, diferenciando entre "add-on" y "annotations". 

==== Compatibilidad con versiones anteriores

gvNIX 2.0.0.M1 ha sufrido grandes cambios de arquitectura debido a las novedades comentadas anteriormente. Por 
este motivo, gvNIX 2.0.0.M1 no es compatible con aplicaciones generadas con versiones anteriores de la herramienta
de desarrollo.
...
en forma de http://docs.spring.io/spring-roo/docs/2.0.0.BUILD-SNAPSHOT/reference/html/#available-roo-addon-suites["Spring Roo Add-On Suite"]
...
A continuación, se muestran una serie de consejos/guías para trabajar con gvNIX desde
un IDE.

En este caso, se mostrará como instalar y utilizar https://spring.io/tools/sts/all[STS 3.7+] incorporando las
funcionalidades de la herramienta de desarrollo gvNIX.
