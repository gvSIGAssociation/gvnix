...
http://docs.spring.io/spring-roo/docs/2.0.0.M1/reference/html/#finder-add[finder
...
comando
http://docs.spring.io/spring-roo/docs/2.0.0.M1/reference/html/#finder-list[finder
list].
