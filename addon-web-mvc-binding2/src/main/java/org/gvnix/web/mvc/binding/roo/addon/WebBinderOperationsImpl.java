...
public class WebBinderOperationsImpl implements WebBinderOperations {
    ...
    public boolean isSetupAvailable() {
        return projectOperations.isProjectAvailable() && !isAllredySetup();
    }
    ...
    private JavaType getInitializerClaseRegistered() {
        ...
        Element rootElement = mvcXml.getDocumentElement();
        ...
        if (beanElement.getAttributes().getNamedItem("class") != null) {
            ...
            String webBindingBeanId = beanElement.getAttributes()
    ...
    private void generateJavaFile(JavaType initializerClass,
            ...
            if (ptm != null
                ...
                if (cid.getImplementsTypes()
                    ...
                    if (stringEmptyAsNull) {
                        logger.warning("The class "
                                + initializerClass
                                + " alredy exist. Check for 'StringTrimmerEditor' manually");
                    }
                    return;
                    ...
                    throw new IllegalStateException(
                            "The class "
                                    + initializerClass
                                    + " exists but doesn't implements 'org.springframework.web.bind.support.WebBindingInitializer'.");
                }
            }
        ...
        // Create a new class
        ClassOrInterfaceTypeDetailsBuilder itdBuilder = new ClassOrInterfaceTypeDetailsBuilder(
                declaredByMetadataId, Modifier.PUBLIC, initializerClass,
                PhysicalTypeCategory.CLASS);

        // Set types implemented my the new class
    ...
    private void setupMvcConfig(JavaType initializerClass) {
        ...
        webBindingInitializerBean.setAttribute("class",
    ...
    private void dropMvcConfig() {
        ...
        XmlUtils.writeXml(XmlUtils.createIndentingTransformer(),
                mvcXmlMutableFile.getOutputStream(), mvcXml);
    }
    ...
    private MethodMetadata getInitBinderMethod(String declaredByMetadataId,
        ...
        // Annotations
        List<AnnotationAttributeValue<?>> annotationAttributes = new ArrayList<AnnotationAttributeValue<?>>();
        AnnotationMetadataBuilder annotation = new AnnotationMetadataBuilder(
                new JavaType(Override.class.getName()),
        ...
        MethodMetadataBuilder mmb = new MethodMetadataBuilder(
                declaredByMetadataId, Modifier.PUBLIC, new JavaSymbolName(
                        "initBinder"), JavaType.VOID_PRIMITIVE,
    ...
    private MethodMetadata getInitBinderMethodWithNotEmptyStrings(
        ...
        return getInitBinderMethod(declaredByMetadataId,
