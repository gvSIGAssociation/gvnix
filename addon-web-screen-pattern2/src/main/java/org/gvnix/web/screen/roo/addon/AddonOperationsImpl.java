...
public class AddonOperationsImpl implements AddonOperations {
	...
	public void setup() {
		...
		projectOperations.addRepository(new Repository("Addon Roo add-on repository", "Addon Roo add-on repository", "https://org.gvnix.web.screen.roo.addon.googlecode.com/svn/repo"));
