...
/**
 * TODO Delete this class if finally not used.
 * 
 ...
 *         Transport</a>
 */
public class ServiceLayerWSImportMetadataNotificationListener implements
	...
	logger.log(Level.INFO, "Notification 1");
	...
	if (MetadataIdentificationUtils.getMetadataClass(upstreamDependency)
	    ...
	    // Show info
	    logger.log(Level.INFO, "Notification 2");
	}
    }
