...
public class WebMvcOperationsImpl implements WebMvcOperations {
    ...
    public void annotateType(JavaType javaType) {
        ...
        if (MemberFindingUtils.getAnnotationOfType(mutableTypeDetails
                .getAnnotations(), new JavaType(RooAddon.class.getName())) == null) {
    ...
    public void setup() {
        ...
        // annotation
        // projectOperations.addRepository(new
        // Repository("Addon Roo add-on repository",
        // "Addon Roo add-on repository",
        // "https://org-gvnix-web-mvc-roo-addon.googlecode.com/svn/repo"));

        List<Dependency> dependencies = new ArrayList<Dependency>();

        // Install the dependency on the add-on jar (
        dependencies.add(new Dependency("org.gvnix",
                "org.gvnix.web.mvc.roo.addon", "1.0.2-SNAPŜHOT", DependencyType.JAR,
                DependencyScope.PROVIDED));

        // Install dependencies defined in external XML file
        // for (Element dependencyElement :
        // XmlUtils.findElements("/configuration/batch/dependencies/dependency",
