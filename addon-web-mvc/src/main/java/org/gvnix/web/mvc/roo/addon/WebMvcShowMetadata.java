...
/**
 * Metadata built from {@link WebScaffoldMetadata}. A single {@link WebMvcShowMetadata} represents all JSPs for an associated controller.
 * The metadata identifier for a {@link WebMvcShowMetadata} is the fully qualifier name of the controller, and the source {@link Path}
 ...
 * @since 1.0
 */
public class WebMvcShowMetadata extends AbstractMetadataItem {
	private static final String PROVIDES_TYPE_STRING = WebMvcShowMetadata.class.getName();
	private static final String PROVIDES_TYPE = MetadataIdentificationUtils.create(PROVIDES_TYPE_STRING);
	private WebScaffoldMetadata webScaffoldMetadata;
	private WebScaffoldAnnotationValues annotationValues;
	
	public WebMvcShowMetadata(String identifier, WebScaffoldMetadata webScaffoldMetadata) {
		super(identifier);
