...
// container
@Service
public class MvcCommands implements CommandMarker { // All command types must
                                                    // implement the
     ...
     *         false otherwise
     */
    @CliAvailabilityIndicator({ "web mvc gvnix setup" })
    public boolean isCommandAvailable() {
        return operations.isSetupAvailable();
    }

    /**
     * Command to enable web mvc gvnix utilities on project
     * 
     * @param type
     */
    @CliCommand(value = "web mvc gvnix setup", help = "Enables gvNIX Web Mvc utilities on project")
    public void setup() {
        operations.setup();
    }
}