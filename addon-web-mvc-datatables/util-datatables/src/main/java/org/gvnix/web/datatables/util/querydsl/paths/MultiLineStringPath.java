...
import org.gvnix.web.datatables.util.querydsl.MultiLineStringExpression;
 ...
 * @param <T>
 */
public class MultiLineStringPath<T extends MultiLineString> extends
        MultiLineStringExpression<T> implements Path<T> {
    ...
    public MultiLineStringPath(Class<? extends T> type, Path<?> parent,
            String property) {
    ...
    public MultiLineStringPath(String var) {
        this((Class<? extends T>) MultiLineString.class, PathMetadataFactory
                .forVariable(var));
    }
