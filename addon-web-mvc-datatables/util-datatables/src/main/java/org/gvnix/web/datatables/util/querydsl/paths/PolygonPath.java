...
import org.gvnix.web.datatables.util.querydsl.PolygonExpression;
 ...
 * @param <T>
 */
public class PolygonPath<T extends Polygon> extends PolygonExpression<T>
        implements Path<T> {
    ...
    public PolygonPath(String var) {
        this((Class<? extends T>) Polygon.class, PathMetadataFactory
                .forVariable(var));
    }
