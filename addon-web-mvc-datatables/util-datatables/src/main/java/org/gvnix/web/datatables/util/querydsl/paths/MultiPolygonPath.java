...
import org.gvnix.web.datatables.util.querydsl.MultiPolygonExpression;
 ...
 * @param <T>
 */
public class MultiPolygonPath<T extends MultiPolygon> extends
        MultiPolygonExpression<T> implements Path<T> {
    ...
    public MultiPolygonPath(Class<? extends T> type, Path<?> parent,
            String property) {
    ...
    public MultiPolygonPath(String var) {
        this((Class<? extends T>) MultiPolygon.class, PathMetadataFactory
                .forVariable(var));
    }
