...
public class PolygonOperation<T extends Polygon> extends PolygonExpression<T>
    ...
    public static <D extends Polygon> PolygonOperation<D> create(Class<D> type,
            Operator<? super D> op, Expression<?> one) {
        return new PolygonOperation<D>(type, op,
    ...
    protected PolygonOperation(Class<T> type, Operator<? super T> op,
            Expression<?>... args) {
