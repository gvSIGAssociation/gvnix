...
import org.gvnix.web.datatables.util.querydsl.PointExpression;
 ...
 * @param <T>
 */
public class PointPath<T extends Point> extends PointExpression<T> implements
        Path<T> {
    ...
    public PointPath(String var) {
        this((Class<? extends T>) Point.class, PathMetadataFactory
                .forVariable(var));
    }
