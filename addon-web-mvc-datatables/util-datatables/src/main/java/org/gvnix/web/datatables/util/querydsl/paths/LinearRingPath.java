...
import org.gvnix.web.datatables.util.querydsl.LinearRingExpression;
 ...
 * @param <T>
 */
public class LinearRingPath<T extends LinearRing> extends
        LinearRingExpression<T> implements Path<T> {
    ...
    public LinearRingPath(Class<? extends T> type, Path<?> parent,
            String property) {
    ...
    public LinearRingPath(String var) {
        this((Class<? extends T>) LinearRing.class, PathMetadataFactory
                .forVariable(var));
    }
