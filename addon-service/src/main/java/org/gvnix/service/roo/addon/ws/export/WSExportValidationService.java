...
public interface WSExportValidationService {
   ...
   * 
   * @param serviceClass to check if the method is correct to be published.
   * @param methodName method to check if input/output parameters ara permitted
   *          to be publish in web service.
   */
   ...
   * 
   * @param javaType of the parameter. Can't be null.
   * @param methodParameterType return or input parameters to check.
   * @param serviceClass where is used the element.
   ...
   * @param methodName to check its exceptions.
   * @param webServiceTargetNamespace Web Service Namespace.
   ...
   * 
   * @param exceptionClass to export as web service exception.
   * @param annotationAttributeValues defined for annotation.
   */
   ...
   * 
   * @param serviceClass Web Service class to check correct target Namespace and
   *          return as result.
   ...
   * </ul>
   * 
   * @param governorTypeDetails class to get fields to check.
   * @param gvNixxmlElementAnnotationMetadata to check element values.
