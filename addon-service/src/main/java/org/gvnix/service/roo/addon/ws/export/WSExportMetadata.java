...
import org.gvnix.service.roo.addon.ws.export.WSExportMetadata;
...
public class WSExportMetadata extends
    ...
    private static Logger logger = Logger
            .getLogger(WSExportMetadata.class.getName());
    ...
    public AnnotationMetadata getWebServiceAnnotation(
        ...
        if (isAnnotationIntroduced("javax.jws.WebService")) {
            ...
            // DiSiD: Use AnnotationMetadataBuilder().build instead of DefaultAnnotationMetadata
