...
public interface WSExportWsdlConfigService {
   ...
   * 
   * @param typeDeclaration to retrieve values from @XmlElement annotations and
   *          convert to {@link GvNIXXmlElement} values.
   * @param fileDirectory to retrieve namespace values generated.
   ...
   * @param javaType to retrieve mandatory Annotation attributed with its values.
