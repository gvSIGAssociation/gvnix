...
public class As3ParserClassMetadataMutableTypeDetailsTests {
    ...
    private static final Log log = LogFactory
            .getLog(As3ParserClassMetadataMutableTypeDetailsTests.class);
    ...
    public void setUp() throws Exception {
        ...
        String fileIdentifier = new ClassPathResource(
                "com/foo/stuff/FooImpl.as").getFile().getCanonicalPath();
        ...
        metadata = new As3ParserClassMetadata(fileManager, fileIdentifier,
                metadataId, metadataService, provider);
        assertNotNull(metadata);
        assertNotNull(metadata.getPhysicalTypeDetails());
        details = (ASMutableClassOrInterfaceTypeDetails) metadata
    ...
    public void testAddSimpleField() throws UnsupportedEncodingException {
        ...
        ASFieldMetadata fieldMetadata = new DefaultASFieldMetadata(metadataId,
                new ActionScriptType("String"), new ActionScriptSymbolName(
                        "name"), ASTypeVisibility.PRIVATE, null, null);
    ...
    // @Test
    public void testAddSimpleFieldWithInitializer()
            throws UnsupportedEncodingException {

        ASFieldMetadata fieldMetadata = new DefaultASFieldMetadata(metadataId,
                ActionScriptType.NUMBER_TYPE, new ActionScriptSymbolName("id"),
                ASTypeVisibility.PRIVATE, "-1", null);
    ...
    public void testAddComplexField() throws UnsupportedEncodingException {
        ...
        ASMetaTagMetadata metaTag = new DefaultASMetaTagMetadata("Bindable",
                null);
        metaTags.add(metaTag);

        ASFieldMetadata fieldMetadata = new DefaultASFieldMetadata(metadataId,
                new ActionScriptType("com.foo.other.Baz"),
                new ActionScriptSymbolName("baz"), ASTypeVisibility.PRIVATE,
                null, metaTags);
    ...
    public void testAddTypeMetaTag() throws UnsupportedEncodingException {
        ...
        ASMetaTagMetadata metaTag = new DefaultASMetaTagMetadata("RemoteClass",
                attributes);
    ...
    private void readLastFile() throws UnsupportedEncodingException {
        this.lastFile = this.outputStream.toString(Charset.defaultCharset()
                .toString());
    }
