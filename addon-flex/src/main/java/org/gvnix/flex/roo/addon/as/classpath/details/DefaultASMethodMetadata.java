 ...
 */
public class DefaultASMethodMetadata extends AbstractInvocableMemberMetadata
    ...
    public DefaultASMethodMetadata(String declaredByMetadataId,
            ActionScriptSymbolName methodName, ActionScriptType returnType,
            ASTypeVisibility visibility, String methodBody,
            List<ASMetaTagMetadata> metaTags,
            List<ActionScriptType> paramTypes,
            List<ActionScriptSymbolName> paramNames) {
        super(declaredByMetadataId, methodBody, metaTags, paramTypes,
                paramNames, visibility);
    ...
    public DefaultASMethodMetadata(String declaredByMetadataId,
        ...
        this(declaredByMetadataId, methodName, returnType, visibility, null,
                null, null, null);
    }
