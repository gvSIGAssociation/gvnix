...
public class Commands implements CommandMarker {
  ...
  public void save(@CliOption(key = "name", mandatory = true, help = "Name of the configuration to be created") String name) {
    ...
    logger.log(Level.INFO, "(use 'configuration property list' to see properties defined in the configuration or 'configuration activate' to update project files with configuration properties)");
  }
  ...
  public void activate(@CliOption(key = "name", mandatory = true, help = "Name of the configuration to be activated") DynConfiguration name) {
    
    // Set the selected dynamic configuration as active
    DynConfiguration dynConf = operations.setActiveConfiguration(name.getName());
    
    // If null, dynamic configuration with this name not exists
    if (dynConf == null) {
      
      logger.log(Level.WARNING, "Configuration not exists");
      logger.log(Level.WARNING, "(use 'configuration list' to see saved configurations or 'configuration save' to create a new configuration)");
    }
    else {
      ...
      if (dynConf.isActive()) {
        ...
        logger.log(Level.INFO, "Configuration activated on project files");
        showDynComponents(dynConf);
        logger.log(Level.INFO, "(now 'configuration property update' will modify project files too, use 'configuration unactivate' to disable)");
      }
      else {
        
        logger.log(Level.SEVERE, "Configuration not activated."  + 
  ...
  public void unactivate(@CliOption(key = "name", mandatory = true, help = "Name of the configuration to be unactivated") DynConfiguration name) {
    
    // Set the selected dynamic configuration as active
    DynConfiguration dynConf = operations.setUnactiveConfiguration(name.getName());
    ...
    if (dynConf == null) {
      ...
      if (dynConf.isActive()) {
        ...
        logger.log(Level.SEVERE, "Configuration not unactivated."  + 
        ...
        logger.log(Level.INFO, "(now 'configuration property update' will not modify project files, only configurations)");
      }
    }
  }
  ...
  public void list() {
    ...
    if (dynConfs == null || dynConfs.size() == 0) {
      ...
      logger.log(Level.WARNING, "(use 'configuration save' to create a new configuration or 'configuration property list' to see properties defined)");
      return;
    }
  ...
  public void delete(@CliOption(key = "name", mandatory = true, help = "Name of the configuration to be removed") DynConfiguration name) {
    ...
    if (deleted) {
      ...
      logger.log(Level.INFO, "(use 'configuration list' to see remaining configurations or 'configuration save' to create a new one)");
    }
    else {
      logger.log(Level.WARNING, "Configuration not exists");
      logger.log(Level.WARNING, "(use 'configuration list' to see saved configurations or 'configuration save' to create a new configuration)");
  ...
  public void propertyList(@CliOption(key = "name", mandatory = false, help = "Name of the configuration to list properties") DynConfiguration name) {
    ...
    if (dynConf.getComponents().isEmpty()) {
      ...
      logger.log(Level.WARNING, "(use 'configuration property add' to make available a configuration property or 'configuration save' to create a new configuration)");
    }
  ...
  public void propertyValues(@CliOption(key = "name", mandatory = true, help = "Property name", optionContext = DynPropertyConverter.CONFIGURATION_FILE) DynProperty name) {
    ...
    if (dynConfs == null || dynConfs.size() == 0) {
      ...
      logger.log(Level.WARNING, "(use 'configuration property add' to make available a configuration property or 'configuration property update' to set property values)");
      return;
    }
  ...
  public void propertyUpdate(@CliOption(key = "configuration", mandatory = true, help = "Name of the configuration to update") DynConfiguration configuration,
    ...
    DynProperty dynProperty = operations.updateProperty(configuration.getName(), property.getKey(), value);
    ...
    logger.log(Level.INFO, "(use 'configuration activate' to update project files with configuration properties if not active yet or 'configuration property values' to show property values)");
  }
  ...
  public void propertyAdd(@CliOption(key = "name", mandatory = true, help = "Name of the property to add", optionContext = DynPropertyConverter.SOURCE_FILES) DynProperty name) {
    
    // Add the property and show a message
    if (operations.addProperty(name.getKey())) {
      
      logger.log(Level.INFO, "Property added");
      logger.log(Level.INFO, "(use 'configuration property update' to set property values or 'configuration save' to create a new configuration)");
    }
    else {
      
      logger.log(Level.WARNING, "Property already exists");
      logger.log(Level.WARNING, "(use 'configuration property update' to set property values or 'configuration property delete' do remove it)");
    }
  }
  ...
  public void propertyDelete(@CliOption(key = "name", mandatory = true, help = "Name of the property to delete", optionContext = DynPropertyConverter.CONFIGURATION_FILE) DynProperty name) {
    ...
    if (operations.deleteProperty(name.getKey())) {
      ...
      logger.log(Level.WARNING, "(use 'configuration property list' to see properties)");
    }
  }
