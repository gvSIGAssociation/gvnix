...
/**
 * Metadata representation of the user interface scaffolding generated for a
 * particular Flex entity.
 * 
 * @author Jeremy Grelle
 */
public class FlexUIMetadata extends AbstractMetadataItem {

    private static final String PROVIDES_TYPE_STRING = FlexUIMetadata.class
            .getName();
