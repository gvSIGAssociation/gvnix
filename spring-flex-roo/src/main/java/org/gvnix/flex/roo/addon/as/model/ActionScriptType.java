...
public final class ActionScriptType implements Comparable<ActionScriptType> {
    ...
    public static final ActionScriptType BOOLEAN_TYPE = new ActionScriptType(
            "Boolean");

    public static final ActionScriptType INT_TYPE = new ActionScriptType("int");

    public static final ActionScriptType NULL_TYPE = new ActionScriptType(
            "Null");

    public static final ActionScriptType NUMBER_TYPE = new ActionScriptType(
            "Number");

    public static final ActionScriptType STRING_TYPE = new ActionScriptType(
            "String");

    public static final ActionScriptType UINT_TYPE = new ActionScriptType(
            "uint");

    public static final ActionScriptType VOID_TYPE = new ActionScriptType(
            "void");

    public static final ActionScriptType OBJECT_TYPE = new ActionScriptType(
            "Object");

    public static final ActionScriptType ARRAY_TYPE = new ActionScriptType(
            "Array");

    public static final ActionScriptType DATE_TYPE = new ActionScriptType(
            "Date");

    public static final ActionScriptType ERROR_TYPE = new ActionScriptType(
            "Error");

    public static final ActionScriptType FUNCTION_TYPE = new ActionScriptType(
            "Function");

    public static final ActionScriptType REGEXP_TYPE = new ActionScriptType(
            "RegExp");

    public static final ActionScriptType XML_TYPE = new ActionScriptType("XML");

    public static final ActionScriptType XML_LIST_TYPE = new ActionScriptType(
            "XMLList");
    ...
    public ActionScriptType(String fullyQualifiedTypeName, int array,
            ASDataType dataType) {
        if (fullyQualifiedTypeName == null
                || fullyQualifiedTypeName.length() == 0) {
            throw new IllegalArgumentException(
                    "Fully qualified type name required");
        }
        ActionScriptSymbolName
                .assertActionScriptNameLegal(fullyQualifiedTypeName);
        ...
        if (!this.defaultPackage
                && !Character.isUpperCase(this.simpleTypeName.charAt(0))) {
            throw new IllegalArgumentException(
                    "The first letter of the type name portion must be uppercase (attempted '"
    ...
    public ActionScriptPackage getPackage() {
        ...
        return new ActionScriptPackage(this.fullyQualifiedTypeName.substring(0,
                offset));
    }
    ...
    public final boolean equals(Object obj) {
        ...
        // efficiency reasons)
        return obj != null
                && obj instanceof ActionScriptType
                && this.fullyQualifiedTypeName
                        .equals(((ActionScriptType) obj).fullyQualifiedTypeName)
