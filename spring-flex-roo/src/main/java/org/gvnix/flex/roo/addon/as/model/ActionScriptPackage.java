...
public class ActionScriptPackage implements Comparable<ActionScriptPackage> {
    ...
    public ActionScriptPackage(String fullyQualifiedPackageName) {
        ...
        ActionScriptSymbolName
                .assertActionScriptNameLegal(fullyQualifiedPackageName);
        Validate.isTrue(
                fullyQualifiedPackageName.toLowerCase().equals(
                        fullyQualifiedPackageName),
                "The entire package name must be lowercase");
    ...
    public final boolean equals(Object obj) {
        return obj != null && obj instanceof ActionScriptPackage
                && this.compareTo((ActionScriptPackage) obj) == 0;
    }
    ...
    public final int compareTo(ActionScriptPackage o) {
        ...
        return this.fullyQualifiedPackageName
                .compareTo(o.fullyQualifiedPackageName);
    }
