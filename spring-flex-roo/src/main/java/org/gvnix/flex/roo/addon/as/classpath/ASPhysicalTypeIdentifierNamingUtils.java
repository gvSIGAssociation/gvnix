...
public class ASPhysicalTypeIdentifierNamingUtils {
    ...
    public static final String createIdentifier(String providesType,
        ...
        return MetadataIdentificationUtils.create(providesType, Path.ROOT + "?"
                + actionScriptType.getFullyQualifiedTypeName());
    }

    public static final ActionScriptType getActionScriptType(
            String providesType, String metadataIdentificationString) {
        Validate.isTrue(
    ...
    public static final LogicalPath getPath(String providesType,
    ...
    public static boolean isValid(String providesType,
        ...
        if (!MetadataIdentificationUtils.getMetadataClass(
                metadataIdentificationString).equals(providesType)) {
            return false;
        }
