...
public interface PatternService {
    ...
    public static final JavaType RELATIONSPATTERN_ANNOTATION = new JavaType(
     ...
     * <p>
     * Pattern names are get from {@link GvNIXPattern} annotation.
     * </p>
     * 
     ...
     * <p>
     * Pattern attributes are get from {@link GvNIXRelatedPattern} annotation.
     * </p>
     * 
     ...
     * <p>
     * Checks if <code>controller</code> is really a controller (annotated with
     * {@link RooWebScaffold} using {@link Assert}).
     * </p>
     * 
     * @param controller Controller java type
     ...
     * <p>
     * Pattern attributes are get from {@link GvNIXPattern} annotation.
     * </p>
     * 
     * @param controller Controller java type
     ...
     * <p>
     * Pattern name is get from {@link GvNIXPattern} annotation.
     * </p>
     * 
     * @param controller Controller java type
     * @param patternName Pattern name to search
    ...
    /**
     * Get OneToMany or ManyToMany annotated field with some name from an
     * entity.
     * 
     * @param entity Entity
     * @param fieldName Field name
     * @return Field metadata if field is annotated with OneToMany or ManyToMany
     *         annotations.
     */
    public FieldMetadata getEntityToManyField(JavaType entity, String fieldName);

    /**
     * Get the list of fields metadata of fields annotated with OneToMany or
     * ManyToMany in a entity.
     * 
     * @param entity Entity
     * @return Field metadata with OneToMany or ManyToMany annotation in a
     *         entity.
     */
    public List<FieldMetadata> getEntityToManyFields(JavaType entity);

    /**
     * Exists a pattern of given {@link WebPatternType} defined in master
     * pattern ?.
     * 
     ...
     * Get used pattern names in project.
     * <p>
     * Pattern names are get from {@link GvNIXRelatedPattern} annotation.
     * </p>
     * 
     * @return Pattern names.
     */
    ...
    /**
     * Get entity fields defined into relations pattern annotation on its
     * related controller.
     * <p>
     * Patterns are get from {@link GvNIXRelationsPattern} annotation. Returns
     * empty set if not relations pattern annotation or null if no entity or
     * controller.
     * </p>
     * 
     ...
     * <p>
     * Patterns are get from {@link GvNIXRelationsPattern} annotation. Returns
     * empty set if not relations pattern annotation or null if no controller.
     * </p>
     * 
    ...
    /**
     * Get a Map where keys is the field and value is the relations pattern for
     * this field.<br/>
     * <p>
     * Patterns are get from {@link GvNIXRelationsPattern} annotation.
     * </p>
     * <code>
    ...
    public Map<String, String> getRelationsPatternFieldAndRelatedPattern(
            AnnotationAttributeValue<?> relationsPatternAttributes);

    /**
     * Get the controller related with some entity.
     * <p>
     * Related controller is a class with RooWebScaffold annotation with form
     * backing object attribute that points to entity. Return null if not exists
     * entity or related controller.
     * </p>
