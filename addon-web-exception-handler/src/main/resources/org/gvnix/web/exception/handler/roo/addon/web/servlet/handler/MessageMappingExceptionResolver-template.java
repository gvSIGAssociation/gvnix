...
import ${PACKAGE}.ModalDialog;


public class MessageMappingExceptionResolver extends
    SimpleMappingExceptionResolver {

   private static final String DEFAULT_DIALOGMESSAGE_ATTRIBUTE = "dialogMessage";
  ...
  /**
   * Create an instance of {@link ModalDialog} and set it as a session attribute.<br/>
  ...
  private void modalDialog(HttpServletRequest request, Exception ex) {
    ...
    ModalDialog modalDialog = new ModalDialog(page, ex);
    session.setAttribute(DEFAULT_DIALOGMESSAGE_ATTRIBUTE, modalDialog);
  }
}
