...
link:#guia-desarrollo_generacion-codigo[modificación del código
generado] y llevarlo al fichero Java de la entidad. Una vez allí
...
en su link:#addon-web-screen-patterns[Add-on Web MVC Pattern] incluye un
...
image:images/iReportFonts.png[Herramienta de gestión de fuentes de
IReport]
...
image:images/recetas-subreport-ireport-1.png[iReport - Diseñador]
...
image:images/recetas-subreport-ireport-2.png[iReport - Report Inspector]
...
image:images/recetas-subreport-ireport-3.png[iReport - Subreport]
...
image:images/recetas-subreport-ireport-4.png[iReport - Nuevo diseño]
...
image:images/recetas-subreport-ireport-6.png[iReport - Bandas subreport]
...
image:images/recetas-subreport-ireport-5.png[iReport - Paleta]
...
image:images/recetas-subreport-ireport-7.png[iReport - Diálogo Text
Field Expression]
...
image:images/recetas-subreport-ireport-8.png[Informe Owners con
subreport Pets]
