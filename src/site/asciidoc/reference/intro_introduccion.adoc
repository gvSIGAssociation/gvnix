...
image::./images/gvnix-arquitectura-v1.0.png[Diagrama Arquitectura,align=center]
...
image::./images/modelo-roo.png[Diagrama de modelo funcional de Roo y gvNIX,align=center]
