...
link:#apendice-comandos_addon-persistence_occchecksum_occ-checksum-set[_occ checksum set_]::
  Aplica el control de concurrencia a una entidad.
link:#apendice-comandos_addon-persistence_occchecksum_occ-checksum-all[_occ checksum all_]::
