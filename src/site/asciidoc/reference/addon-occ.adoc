...
link:#apendice-comandos_addon-persistence_occchecksum_occ-checksum-set['occ checksum set']::
  Aplica el control de concurrencia a una entidad.
link:#apendice-comandos_addon-persistence_occchecksum_occ-checksum-all['occ checksum all']::
