...
de persistencia en bloque generadas por el link:#addon-jpa_batch['add-on jpa']
...
link:#apendice-comandos_addon-web-mvc_mvc-batch_web-mvc-batch-setup['web mvc batch setup']::
  Instala las dependencias y ajusta la configuración.
link:#apendice-comandos_addon-web-mvc_mvc-batch_web-mvc-batch-add['web mvc batch add']::
  Genera los métodos en un controlador.
link:#apendice-comandos_addon-web-mvc_mvc-batch_web-mvc-batch-all['web mvc batch all']::
...
link:#_add_on_web_mvc_datatables[add-on web mvc datatables] es necesario
...
link:#apendice-comandos_addon-web-mvc_mvc-jquery_web-mvc-jquery-update-tags['web mvc jquery update tags']::
