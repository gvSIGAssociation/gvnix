...
de persistencia en bloque generadas por el link:#addon-jpa_batch[_add-on jpa_]
...
link:#apendice-comandos_addon-web-mvc_mvc-batch_web-mvc-batch-setup[_web mvc batch setup_]::
  Instala las dependencias y ajusta la configuración.
link:#apendice-comandos_addon-web-mvc_mvc-batch_web-mvc-batch-add[_web mvc batch add_]::
  Genera los métodos en un controlador.
link:#apendice-comandos_addon-web-mvc_mvc-batch_web-mvc-batch-all[_web mvc batch all_]::
...
link:#apendice-comandos_addon-web-mvc_mvc-jquery_web-mvc-jquery-update-tags[_web mvc jquery update tags_]::
